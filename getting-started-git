...
Setting up
------------
I recommend connecting to [GitHub via SSH](https://docs.github.com/en/github/authenticating-to-github/adding-a-new-ssh-key-to-your-github-account). If you use https, that is also fine, but this tutorial assumes ssh. If you are using https, just use the https url in place of the ssh url.
...
------------
For testing and educational purposes, what is above is sufficient. In real life, this is the correct practice.

You now have a git repository, likely with two branches: main and develop. Now bake these laws into your mind and process:

####You will never commit to ***main*** directly.
